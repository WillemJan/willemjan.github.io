...
The data will be processed on the Raspberry PI, from your internal network you will only need access to the Raspberry PI's webinterface to look at the stats generated.
